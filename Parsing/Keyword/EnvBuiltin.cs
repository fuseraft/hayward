...
public static class EnvBuiltin
{
    ...
    public const string Hayward                    = "__env_bin__";
    public const string HaywardLib                 = "__env_lib__";
    ...
    private static readonly IReadOnlyDictionary<string, TokenName> _map
        = new Dictionary<string, TokenName>
        {
            ...
            { Hayward,                   TokenName.Builtin_Env_Hayward },
            { HaywardLib,                TokenName.Builtin_Env_HaywardLib }
        };
