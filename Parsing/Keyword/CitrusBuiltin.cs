...
public static class KiwiBuiltin
{
    ...
    private static readonly IReadOnlyDictionary<string, TokenName> _map
        = new Dictionary<string, TokenName>
        {
            ...
            { Hour,         TokenName.Builtin_Kiwi_Hour        },
            { Minute,       TokenName.Builtin_Kiwi_Minute      },
            { Second,       TokenName.Builtin_Kiwi_Second      },
            { Millisecond,  TokenName.Builtin_Kiwi_Millisecond },
            { Day,          TokenName.Builtin_Kiwi_Day         },
            { Month,        TokenName.Builtin_Kiwi_Month       },
            { Year,         TokenName.Builtin_Kiwi_Year        },
        };
